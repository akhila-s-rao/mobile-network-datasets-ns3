...
def second_phase_training(pt_type):
    ...
    notebook_save_str = iteration+'_s3l_frozen_'+pt_type
    ...
    os.system('cp second_phase_learning.py '+models_folder+notebook_save_str+'.py')
